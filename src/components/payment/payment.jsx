      ...
      <div className={style.payment}>
        ...
        <div className={style.paymentContent}>
          <div className={style.paymentContentHeader}>
            ...
            <div>
              <button className={style.paymentContentBtn}>Add Voucher</button>
            </div>
          </div>
          ...
          <div className={style.shipping}>
            <div className={style.shippingHeader}>
              Shipping Options
            </div>
            <div className={style.shippingOptions}>
            <div
                className={`${style.shippingOption} ${selectedShipping === "standard" ? style.selected : ""}`}
              ...
              <div
                className={`${style.shippingOption} ${selectedShipping === "express" ? style.selected : ""}`}
            ...
            <div className={style.shippingText}>Delivered on or before Thursday, 23 April 2020</div>
          </div>
          ...
          <div className={style.container}>
            <div className={style.content}>
              ...
              <div className={style.checkoutRight}>
                <button className={style.checkoutBtn}>Pay</button>
              </div>
            </div>
          </div>
        </div>
